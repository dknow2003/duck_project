				...
				<div class="ibox float-e-margins">
					...
					<div class="row" style="padding-right: 15px;">
						...
						<div class="col-sm-4" style="padding: 20px 0;">
							<form action="{{ url('orders/check') }}" method="GET"
							      id="search-form">
						...
						<div class="table-responsive">
							<table class="table table-striped">
								...
								@foreach($orders as $order)
									<tr>
										<td><a data-toggle="tooltip" data-placement="top" title="查看该角色所有充值" href="{{ url('orders/check?aid=' . $order->aid) }}">{{ $order->aid}}</a></td>
										<td>{{ $order->role->RoleName }}</td>
