			...
			<div class="col-lg-12 animated fadeInRight">
				<div class="ibox float-e-margins">
					...
					<div class="row" style="padding-right: 15px;">
						...
						?>
							<form action="{{ url('channel/login-log') }}" method="GET"
							      id="search-form">
							...
							<table class="table table-striped">
								...
								@foreach($loginLogs as $loginLog)
									<tr>
										...
										<td><a data-toggle="tooltip" data-placement="top" title="查看该角色登录日志" href="{{ url('channel/login-log?user_id=' .$loginLog->UserID) }}">{{ isset($loginLog->role) ? $loginLog->role->RoleName : '未定义' }}</a></td>
										...
										<td>
										 @if($loginLog->State == 0)
												<i class="fa fa-check-square" data-toggle="tooltip" data-placement="top" title="当前正常" style="color:#18a689;"></i><span style="margin-left: 10px;">正常</span>
											  @elseif ($loginLog->State == 1)
											 <i class="fa fa-minus-square"  data-toggle="tooltip" data-placement="top" title="已封禁" style="color: #b24374"></i><span style="margin-left: 10px; color:#b24374;">已封禁</span>
											 @endif
										</td>
									</tr>
								@endforeach
