						...
						<div class="tabs-container">
							<ul class="nav nav-tabs">
								...
								<li class=""><a data-toggle="tab" data-method="active"
								                href="#tab-2" data-download-area="#download-key" data-download-link="/analyze/summarize/json?method=active&export=true&fetch=active&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}&by=month">活跃玩家</a>
								</li>
								<li class=""><a data-toggle="tab" data-method="payed"
								                href="#tab-3" data-download-area="#download-key" data-download-link="/analyze/summarize/json?method=payed&export=true&fetch=payed&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}&by=month">付费玩家</a>
								</li>
								<li class=""><a data-toggle="tab" data-method="incoming"
								                href="#tab-4" data-download-area="#download-key" data-download-link="/analyze/summarize/json?method=incoming&export=true&fetch=incoming&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}&by=month">收入</a>
								</li>
							</ul>
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<div class="tabs-container">
							<ul class="nav nav-tabs">
								<li class="active">
									<a data-toggle="tab" href="#tab-pay-1" data-filled="true" data-method="pur"  data-download-area="#download-pay" data-download-link="?export=true&fetch=pay-percent&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}&by=month">付费率</a>
								</li>
								<li >
									<a data-toggle="tab" href="#tab-pay-2" data-method="arpu"  data-download-area="#download-pay" data-download-link="/analyze/summarize/json?method=arpu&export=true&fetch=arpu&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}&by=month">ARPU</a>
								</li>
								<li class="">
									<a data-toggle="tab" href="#tab-pay-3" data-method="arppu"  data-download-area="#download-pay" data-download-link="/analyze/summarize/json?method=arppu&export=true&fetch=arppu&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}&by=month">ARPPU</a>
								</li>
								<li class="">
									<a data-toggle="tab" href="#tab-pay-4" data-method="au-avg"  data-download-area="#download-pay" data-download-link="/analyze/summarize/json?method=au-avg&export=true&fetch=au-avg&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}&by=month">活跃用户平均付费</a>
								</li>
							</ul>
							<div class="tab-content">
