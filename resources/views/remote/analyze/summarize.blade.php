					...
					<div class="row">
						...
						<div class="col-xs-8">
							...
							<div class="col-xs-10 text-left">
								...
								<h2 class="font-bold">{{ $players['registers'] }}
									/ {{ $players['actives'] }} / {{ $players['payed'] }}</h2>
							</div>
						</div>
					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							<a class="btn btn-primary btn-circle"
							   href="?export=true&fetch=acu-pcu">
			...
			<div class="col-lg-12" id="download-key">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>关键指标</h5>
						<div class="ibox-tools">
							<a class="btn btn-primary btn-circle export-button"
							   href="?export=true&fetch=login-register">
								<i class="fa fa-download"></i>
							</a>
						</div>
					</div>
						...
						<div class="tabs-container">
							<ul class="nav nav-tabs">
								<li class="active"><a data-toggle="tab" data-method="new"
								                      data-filled="true" href="#tab-1"
								                      data-download-area="#download-key"
								                      data-download-link="?export=true&fetch=login-register&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}">新增玩家</a>
								</li>
								<li class=""><a data-toggle="tab" data-method="active"
								                href="#tab-2" data-download-area="#download-key"
								                data-download-link="/analyze/summarize/json?method=active&export=true&fetch=active&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}">活跃玩家</a>
								</li>
								<li class=""><a data-toggle="tab" data-method="payed"
								                href="#tab-3" data-download-area="#download-key"
								                data-download-link="/analyze/summarize/json?method=payed&export=true&fetch=payed&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}">付费玩家</a>
								</li>
								<li class=""><a data-toggle="tab" data-method="incoming"
								                href="#tab-4" data-download-area="#download-key"
								                data-download-link="/analyze/summarize/json?method=incoming&export=true&fetch=incoming&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}">收入</a>
								</li>
							</ul>
							<div class="tab-content">
								...
								<div id="tab-3" class="tab-pane fade in">
									<div class="panel-body">
										...
										{{--  付费玩家 --}}
										<canvas id="payed-player" class="chart"
										        height="60"></canvas>
									</div>
								</div>
			...
			<div class="col-lg-12" id="download-pay">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							<a class="btn btn-primary btn-circle export-button"
							   href="?export=true&fetch=pay-percent">
								<i class="fa fa-download"></i>
							</a>
						</div>
					</div>
					<div class="ibox-content">
						<div class="tabs-container">
							<ul class="nav nav-tabs">
								<li class="active">
									<a data-toggle="tab" href="#tab-pay-1" data-filled="true"
									   data-method="pur" data-download-area="#download-pay"
									   data-download-link="?export=true&fetch=pay-percent&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}&by=day">付费率</a>
								</li>
								<li>
									<a data-toggle="tab" href="#tab-pay-2" data-method="arpu"
									   data-download-area="#download-pay"
									   data-download-link="/analyze/summarize/json?method=arpu&export=true&fetch=arpu&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}&by=day">ARPU</a>
								</li>
								<li class="">
									<a data-toggle="tab" href="#tab-pay-3" data-method="arppu"
									   data-download-area="#download-pay"
									   data-download-link="/analyze/summarize/json?method=arppu&export=true&fetch=arppu&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}&by=day">ARPPU</a>
								</li>
								<li class="">
									<a data-toggle="tab" href="#tab-pay-4" data-method="au-avg"
									   data-download-area="#download-pay"
									   data-download-link="/analyze/summarize/json?method=au-avg&export=true&fetch=au-avg&from={{ $players['display_from'] }}&to={{ $players['display_to'] }}&by=day">活跃用户平均付费</a>
								</li>
							</ul>
							<div class="tab-content">
								...
								<div id="tab-pay-2" class="tab-pane">
									<div class="panel-body">
										...
										<canvas id="arpu" height="60" class="chart"></canvas>
									</div>
								</div>
								<div id="tab-pay-3" class="tab-pane">
									<div class="panel-body">
										...
										<canvas id="arppu" height="60" class="chart"></canvas>
									</div>
								</div>
								<div id="tab-pay-4" class="tab-pane">
									<div class="panel-body">
										...
										<canvas id="au-avg" height="60" class="chart"></canvas>
									</div>
								</div>
